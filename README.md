...
CredShield is a **privacy-preserving verifiable credential platform** built on the [Midnight Blockchain](https://CredShield.network). It enables certified institutions to issue tamper-proof credentials while allowing holders to **prove credential validity without disclosing their identity**.
