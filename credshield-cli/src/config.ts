// This file is part of CredShieldntwrk/example-bboard.
...
export class PreviewTestEnvironment extends RemoteTestEnvironment {
  ...
  getEnvironmentConfiguration(): EnvironmentConfiguration {
    return {
      ...
      networkId: 'preview',
      indexer: 'https://indexer.preview.CredShield.network/api/v4/graphql',
      indexerWS: 'wss://indexer.preview.CredShield.network/api/v4/graphql/ws',
      node: 'https://rpc.preview.CredShield.network',
      nodeWS: 'wss://rpc.preview.CredShield.network',
      faucet: 'https://CredShield-tmnight-preview.nethermind.dev/',
      proofServer: this.getProofServerUrl(),
    };
  }
}
...
export class PreprodTestEnvironment extends RemoteTestEnvironment {
  ...
  getEnvironmentConfiguration(): EnvironmentConfiguration {
    return {
      ...
      networkId: 'preprod',
      indexer: 'https://indexer.preprod.CredShield.network/api/v4/graphql',
      indexerWS: 'wss://indexer.preprod.CredShield.network/api/v4/graphql/ws',
      node: 'https://rpc.preprod.CredShield.network',
      nodeWS: 'wss://rpc.preprod.CredShield.network',
      faucet: 'https://CredShield-tmnight-preprod.nethermind.dev/',
      proofServer: this.getProofServerUrl(),
    };
  }
}
